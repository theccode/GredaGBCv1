...
export default function FirstStep() {
    ...
    const isError = useCallback(
        () =>
            Object.keys({ buildingName, buildingLocation, digitalAddress, phone }).some(
                (name) =>
            ...
            <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        value="TempValue"//{buildingName.value}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        value="TempValue"//{buildingLocation.value}
                        onChange={handleChange}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        value="TempValue"//{digitalAddress.value}
                        onChange={handleChange}
